		...
		void setSimpleItem(Object obj) {
			...
			if (obj instanceof HLUserGeneric) {
				...
				if (Utils.isStringValid(((Interest) obj).getAvatarURL())) {
					MediaHelper.loadProfilePictureWithPlaceholder(profilePicture.getContext(),
						((Interest) obj).getAvatarURL(), profilePicture, true);
				}
				else profilePicture.setImageResource(R.drawable.ic_interest_placeholder);
				...
				if (Utils.isStringValid(((Tag) obj).getUserUrl())) {
					MediaHelper.loadProfilePictureWithPlaceholder(profilePicture.getContext(),
						((Tag) obj).getUserUrl(), profilePicture, ((Tag) obj).isInterest());
				}
				else profilePicture.setImageResource(((Tag) obj).isInterest() ? R.drawable.ic_interest_placeholder : R.drawable.ic_profile_placeholder);
