package com.groops.fairsquare.widgets
...
/**
 * This subclass of [ImageView] attempts to work around the limitation of @hdodenhof's
 * [de.hdodenhof.circleimageview.CircleImageView] (v2.2.0) regarding [ImageView.ScaleType.CENTER_CROP] as
 * only acceptable value.
 *
 * @author mbaldrighi on 3/27/2019.
 */
class FitCenterCircleImageView: ImageView {
    ...
    private val defaultBorderWidth = 0
    private val defaultBorderColor = Color.BLACK
    private val defaultCircleBackgroundColor = Color.TRANSPARENT
    private val defaultBorderOverlay = false
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int): super(context, attrs, defStyleAttr) {
        ...
        val a = context.obtainStyledAttributes(attrs, R.styleable.FitCenterCircleImageView, defStyleAttr, 0)

        mBorderWidth = a.getDimensionPixelSize(R.styleable.FitCenterCircleImageView_civ_border_width, defaultBorderWidth)
        mBorderColor = a.getColor(R.styleable.FitCenterCircleImageView_civ_border_color, defaultBorderColor)
        mBorderOverlay = a.getBoolean(R.styleable.FitCenterCircleImageView_civ_border_overlay, defaultBorderOverlay)

        // Look for deprecated civ_fill_color if civ_circle_background_color is not set
        if (a.hasValue(R.styleable.FitCenterCircleImageView_civ_circle_background_color)) {
            mCircleBackgroundColor = a.getColor(R.styleable.FitCenterCircleImageView_civ_circle_background_color,
                    defaultCircleBackgroundColor)
        }
...
//    }
    ...
    @Deprecated("Use {@link #setBorderColor(int)} instead", ReplaceWith("setBorderColor(getContext().getResources().getColor(borderColorRes))"))
