...
public class AnalyticsUtils {
	...
	/* HOME */
	public static final String HOME_GLOBAL_SEARCH = "GlobalSearch";
	...
	/* MENU */
	public static final String HOME_MENU = "HomeMenuView";
	public static final String HOME_MENU_INDUSTRIES = "HomeIndustriesView";
	public static final String HOME_MENU_BRANDS = "HomeIndustriesBrandsView";
	...
	/* INTEREST */
	public static final String INTEREST_DETAIL = "InterestDetail";
	public static final String INTEREST_BRANDS = "InterestBrandsView";
	public static final String INTEREST_PRODUCTS = "InterestProductsView";
