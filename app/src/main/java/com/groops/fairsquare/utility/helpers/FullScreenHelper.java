...
public class FullScreenHelper {
	...
	public FullScreenHelper(Context context, boolean diaryMode) {
		if (Utils.isContextValid(context)) {
			...
			expHeightT = Utils.getToolbarHeight(context);
		}
...
//		}
	 ...
	 *
	 * @param toolbar     {@link com.groops.fairsquare.activities_and_fragments.activities_home.HomeActivity}'s {@link Toolbar}.
	 * @param bottomBar   {@link com.groops.fairsquare.activities_and_fragments.activities_home.HomeActivity}'s bottom bar {@link View}.
...
//						maskLower.setVisibility(View.GONE);
	...
	/**
	 * Tells whether the current {@link com.groops.fairsquare.utility.helpers.FullScreenHelper.FullScreenType}
	...
	/**
	 * Tells whether the helper has been invoked from {@link com.groops.fairsquare.activities_and_fragments.activities_home.timeline.TimelineFragment} displaying a user's or not.
	 *
	 * @return True if the helper is in single mode, false otherwise.
	 */
