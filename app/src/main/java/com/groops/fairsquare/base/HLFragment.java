...
import com.groops.fairsquare.activities_and_fragments.activities_chat.ChatActivityListener;
import com.groops.fairsquare.activities_and_fragments.activities_home.global_search.GlobalSearchActivityListener;
import com.groops.fairsquare.activities_and_fragments.activities_home.menu.MenuActivityListener;
import com.groops.fairsquare.activities_and_fragments.activities_home.profile.ProfileActivityListener;
import com.groops.fairsquare.activities_and_fragments.activities_home.settings.SettingsActivityListener;
import com.groops.fairsquare.activities_and_fragments.activities_home.wishes.WishesActivityListener;
import com.groops.fairsquare.activities_and_fragments.activities_onboarding.OnBoardingActivityListener;
...
public abstract class HLFragment extends Fragment implements OnServerMessageReceivedListener {
	...
	protected MenuActivityListener menuActivityListener;
	protected OnBoardingActivityListener onBoardingActivityListener;
...
//				getActivity().unregisterReceiver(serverMessageReceiver);
	...
	public void onAttach(Context context) {
		...
		if (context instanceof MenuActivityListener)
			menuActivityListener = (MenuActivityListener) context;
		if (context instanceof OnBoardingActivityListener)
			onBoardingActivityListener = (OnBoardingActivityListener) context;
	}
	...
	public void onAttach(Activity activity) {
		...
		if (activity instanceof MenuActivityListener)
			menuActivityListener = (MenuActivityListener) activity;
		if (activity instanceof OnBoardingActivityListener)
			onBoardingActivityListener = (OnBoardingActivityListener) activity;
	}
