...
import com.groops.fairsquare.models.enums.LegacyContactStatusEnum;
...
public class HLUser implements JsonHelper.JsonDeSerializer, RealmModel, RealmModelListener {
	...
	private String selectedFeedChannel;
...
//			}
	...
	public List<HLIdentity> getIdentitiesOtherThanCurrentSelf() {
		List<HLIdentity> list = new ArrayList<>();
		if (hasIdentities()) {
			list = Stream.of(getIdentities())
					.filter(value -> Utils.areStringsValid(value.getId(), getId()) && !value.getId().equals(getId()))
...
//	}
	...
	public String getSelectedFeedChannel() {
		return selectedFeedChannel;
	}
	public void setSelectedFeedChannel(String selectedFeedChannel) {
		this.selectedFeedChannel = selectedFeedChannel;
	}
