...
import com.groops.fairsquare.utility.LottieCompositioListener;
import com.groops.fairsquare.utility.TapAndHoldGestureListener;
	...
	public void onActivityCreated(@Nullable Bundle savedInstanceState) {
		...
		if (getActivity() instanceof HLActivity) {
			...
			if (siriComposition == null) {
				HLApp.initLottieAnimation(getActivity(), new LottieCompositioListener() {
					@Override
