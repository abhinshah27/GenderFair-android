...
import kotlinx.android.synthetic.main.gf_toolbar_transp_wv_doc.view.*
...
class WebViewActivityDocuments : HLActivity(), ShareHelper.ShareableProvider {
    ...
    override fun onStart() {
        ...
        toolbar.shareBtn.visibility = if (getPostOrMessageID().isBlank()) View.GONE else View.VISIBLE
